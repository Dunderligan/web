				...
				<div class="flex flex-col">
					{#each Array.from({ length: round.length / 2 }) as i}
						...
						<svg {width} height="100%" xmlns="http://www.w3.org/2000/svg">
							<line y2="25%" x2={width / 2} y1="25%" x1="0" stroke="#000" />
							<line y2="75%" x2={width / 2} y1="75%" x1="0" stroke="#000" />

							<line y2="50%" x2={width / 2} y1="50%" x1={width} stroke="#000" />
							<line y2="75%" x2={width / 2} y1="25%" x1={width / 2} stroke="#000" />
						</svg>
					{/each}
				</div>
			{/if}
